...
class FocusingAction extends SurelutionBaseAction{
	...
	public void execute() {
		...
		ne.add("欢迎关注我们", "", rootPath+"/images/hospital.jpg?v=${RandomUtils.nextFloat()}","http://mp.weixin.qq.com/s?__biz=MzIxNzAyMjA5Ng==&mid=207059090&idx=1&sn=d657045db176c42dc182a05c9b27b663&scene=18#rd")	
		put(ne)
	}
